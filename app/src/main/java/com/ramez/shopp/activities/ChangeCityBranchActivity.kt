...
class ChangeCityBranchActivity : ActivityBase(), OnCountryClick {
    ...
    var oldCountryName: String? = null
    var newCountryName: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        countries = ArrayList()
        localModel =
            if (UtilityApp.getLocalData() != null) UtilityApp.getLocalData()
            else UtilityApp.getDefaultLocalData(
                activity
            )
...
//        Log.i("tag", "Log cityId" + localModel.getCityId());
    ...
    fun onCitySelected(position: Int, cityModel: CityModel) {
        cityId = cityModel.id
