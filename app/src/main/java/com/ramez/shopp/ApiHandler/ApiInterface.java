...
ApiInterface {
    ...
    @POST("v5/Locations/storedetails")
    ...
    @GET("v5/Products/singleproductList")
    ...
    @GET("v5/Products/productRecipeList")
    ...
    @POST("v5/Booklets/BrochuresList")
