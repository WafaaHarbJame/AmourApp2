...
public class ContactSupportActivity extends ActivityBase {
    ...
    private void uploadPhoto(int userId, File photo) {
        ...
        AndroidNetworking.upload(GlobalData.BetaBaseURL + country + GlobalData.grocery + GlobalData.Api + "v5/Account/UploadPhoto" + "?user_id=" + userId).addMultipartFile("file", photo)
