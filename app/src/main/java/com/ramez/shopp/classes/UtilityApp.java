...
//        return FCMToken[0];
    ...
    public static void setUserToken(String userToken) {
        ...
        RootApplication.Companion.getInstance().getSharedPManger().SetData(Constants.KEY_TOKEN, userToken);
    }


    public static String getUserToken() {

        return RootApplication.Companion.getInstance().getSharedPManger().getDataString(Constants.KEY_TOKEN, "");
    }

    public static String getRefreshToken() {

        return RootApplication.Companion.getInstance().getSharedPManger().getDataString(Constants.KEY_REFRESH_TOKEN, "");
    }


    public static void setRefreshToken(String refreshToken) {

        RootApplication.Companion.getInstance().getSharedPManger().SetData(Constants.KEY_REFRESH_TOKEN, refreshToken);
    }
