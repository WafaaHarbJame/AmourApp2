...
import com.amour.shop.Dialogs.SortDialog
import com.amour.shop.Utils.ActivityHandler
import com.amour.shop.activities.ActivityBase
import com.amour.shop.databinding.ActivityMainBinding
import com.amour.shop.fragments.*
...
import com.amour.shop.activities.AllBookleteActivity
import com.amour.shop.activities.ExtraRequestActivity
...
//                newFragment = InvoiceFragment()
                ...
                intent = intent.replaceExtras(bundle)
                startActivity(intent)
            }
