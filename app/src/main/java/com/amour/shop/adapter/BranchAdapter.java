...
import com.amour.shop.databinding.RowItemBranchBinding;
...
public class BranchAdapter extends RecyclerView.Adapter<BranchAdapter.ViewHolder> {
    ...
    public BranchAdapter(Context context, List<CityModel> list, int selectedPosition, OnCityClick onClick) {
