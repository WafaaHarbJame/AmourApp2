...
import com.amour.shop.Utils.PathUtil
import com.amour.shop.adapter.ChatAdapter
import com.amour.shop.databinding.ActivityContactSupportBinding
...
class ContactSupportActivity : ActivityBase() {
    ...
    private fun uploadPhoto(userId: Int, photo: File?) {
        ...
        var country: String = if (localModel?.shortname != null) {
        ...
        AndroidNetworking.upload(UtilityApp.getUrl() + country + GlobalData.amour + GlobalData.Api + " v9/Account/UploadPhoto" + "?user_id=" + userId)
