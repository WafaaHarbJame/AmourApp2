...
import com.amour.shop.adapter.OrderProductsAdapter
import com.amour.shop.databinding.ActivityInvoiceInfoBinding
...
//                println("Log localModel ${localModel} cityId ${localModel?.cityId}")
