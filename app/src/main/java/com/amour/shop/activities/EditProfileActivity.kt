...
import com.amour.shop.databinding.ActivityEditProfileBinding
...
class EditProfileActivity : ActivityBase() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        country = localModel?.shortname ?: GlobalData.COUNTRY
            ...
            override fun Result(obj: Any?, func: String?, IsSuccess: Boolean) {
                ...
                if ((func == Constants.ERROR)) {
                    ...
                    if (IsSuccess) {
                        ...
                        Log.i("tag", "Log  updateProfile  ${result.status}")
                        Log.i("tag", "Log  updateProfile  ${result.message}")
