...
import com.amour.shop.Dialogs.CountryCodeDialog
import com.amour.shop.Dialogs.StateDialog
import com.amour.shop.Models.*
import com.amour.shop.R
import com.amour.shop.Utils.ImageHandler
import com.amour.shop.Utils.MapHandler
...
import com.amour.shop.databinding.ActivityAddNewAddressBinding
...
//                            intent.putExtra(Constants.ADDRESS_ID, result?.data?.last()?.id)
    ...
    private val getIntentData: Unit
        get() {
            ...
            if (bundle != null) {
               ...
               // keyAddNew = bundle.getBoolean(Constants.KEY_ADD_NEW)
