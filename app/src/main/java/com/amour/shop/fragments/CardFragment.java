...
import com.amour.shop.adapter.CardsTransAdapter;
...
import com.amour.shop.Models.SettingCouponsModel;
import com.amour.shop.Models.TotalPointModel;
import com.amour.shop.Models.TransactionModel;
import com.amour.shop.R;
import com.amour.shop.databinding.FragmentCardBinding;
...
public class CardFragment extends FragmentBase {
    ...
    private void getData() {
        ...
        if (UtilityApp.INSTANCE.getUserData() != null && UtilityApp.INSTANCE.getUserData().getId() != null) {
            userId = UtilityApp.INSTANCE.getUserData().getId();
            coupBarcode = UtilityApp.INSTANCE.getUserData().getLoyalBarcode();
            getTotalPoint();
            getCouponSettings();
            callApi();
